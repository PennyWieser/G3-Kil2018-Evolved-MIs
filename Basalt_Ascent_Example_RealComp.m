%% This code shows how the degassing model shown in Figure 7 was run for the basaltic andesite.
% MELTS for matlab version 1.0
clear all 
close all
%% Load in path to MELTS for Matlab here (replace ... with your path)
addpath('...\MELTS_Matlab-master\package')
...
%% Setting bulk - Average composition of Early Rift stored matrix glasses,
% CO2 and H2O from MELTS model brought to saturation for this composition.

bulk(1)=50.8924 %SiO2
bulk( 2) = 4.4309% TiO2
bulk( 3) =12.1318% Al2O3
bulk( 4) =1.5519% Fe2O3 
bulk( 5) = 0 % Cr2O3
bulk( 6) =12.5704% FeO 
bulk( 7) =0.2025%  MnO
...
Excel_out=[P_1' CO2M_1 Vol_vol_1 Vol_melt_1' Vol_bulk_1']
